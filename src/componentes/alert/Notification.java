...
//            lbIcon.setIcon(new javax.swing.ImageIcon(Notification.class.getResource("NIXAS-/src/componentes/alert/success.png")));
            lbMessage.setText("Success");
        }else if (type == Type.WARNING) {
//            lbIcon.setIcon(new javax.swing.ImageIcon(Notification.class.getResource("NIXAS-/src/componentes/alert/warning.png")));
            lbMessage.setText("Error");
        }else{
//           lbIcon.setIcon(new javax.swing.ImageIcon(Notification.class.getResource("/componentes/alert/info.png")));
        ...
        }
{
    ...
    private void initComponents() {
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/componentes/alert/close.png"))); // NOI18N
