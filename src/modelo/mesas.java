...
public class mesas extends tmpPedidos{
    ...
    public mesas(int cantSillas, String tipoMesa, String estadoMesa, int idMesas, int idPedidos, int mesero, int cantidad, int hora, String producto, String estado, int idEmpl, Integer cedulaEmpl, Integer celEmpl, int idRol, String nombreEmpl, String apellidoEmpl, String userEmpl, String claveEmpl, String nombreRol, String direccion) {
